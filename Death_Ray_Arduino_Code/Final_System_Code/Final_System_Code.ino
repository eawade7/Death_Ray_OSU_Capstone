...
int rotationCount = 0.0; // b/c encoder is attached to small gear side, a complete rotation of the small gear
...
void loop() {
  ...
  // if solar elevation is above 40 degrees and less than 70 we should decide if the dish should change its tilt
